    ...
    <div id="page-wrapper">
        ...
        <div class="well">
          ...
          <div class="form-group col-md-offset-1 col-md-10">
            <textarea class="form-control" rows="10" id="comment" placeholder="Please Enter the Reason"></textarea>
          </div>
        </div>
        <div class="row">
        <div class="col-md-offset-10">
          <button type="button" class="btn btn-primary"><i class="fa fa-paper-plane fa-lg" aria-hidden="true"></i> Send</button>
            </div>
        </div>
      </div>
    </div>
